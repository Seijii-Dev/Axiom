...
val LocalAxiomEditorColorScheme = compositionLocalOf<AxiomEditorColorScheme> {
    error("No AxiomEditorColorScheme provided")
}

@Composable
fun rememberEditorColorScheme(): AxiomEditorColorScheme {
