...
import com.axiom.network.httpClient
                ...
                try {
                    file.download(
                        onDownload = { sent, total ->
                            ...
                            onTotalProgress(downloaded.get(), totalBytes.takeIf { it > 0 })
                        },
...
suspend fun getContentLength(url: String) =
    runCatching { httpClient.head(url).contentLength() }.getOrNull()
