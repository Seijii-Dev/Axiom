...
import com.axiom.api.lsp.languageId
import com.axiom.core.koin
import com.axiom.data.preferences.SettingsRepository
import com.axiom.lsp.capabilities.ServerCapabilities
...
@OptIn(InternalAxiomApi::class, FlowPreview::class)
@Single
class LspManager(
