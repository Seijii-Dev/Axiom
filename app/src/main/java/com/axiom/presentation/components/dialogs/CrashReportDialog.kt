package com.axiom.presentation.components.dialogs
        ...
        Surface(
            ...
            Column(
                ...
                Row(
                    ...
                    FilledTonalButton(
                        onClick = {
                            uriHandler.openUri("https://github.com/Seijii-Dev/Axiom/issues")
                        },
                        modifier = Modifier
                            .weight(1f)
...
private fun copyToClipboard(context: Context, crash: CrashHandler.CrashData) {
    ...
    clipboard.setPrimaryClip(ClipData.newPlainText("Axiom Crash Report", text))
}
