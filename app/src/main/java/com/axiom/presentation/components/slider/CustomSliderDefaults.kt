package com.axiom.presentation.components.slider
...
/**
 * Object to hold defaults used by [com.axiom.presentation.components.slider.CustomSlider]
 */
@Stable
object CustomSliderDefaults {
     ...
     * [com.axiom.presentation.components.slider.CustomSlider] in different states.
     */
    @Composable
    fun colors() = colors(
    ...
    /**
     * The Default thumb for [com.axiom.presentation.components.slider.CustomSlider] and [CustomRangeSlider]
     *
    ...
    /**
     * The Default track for [com.axiom.presentation.components.slider.CustomSlider]
     *
