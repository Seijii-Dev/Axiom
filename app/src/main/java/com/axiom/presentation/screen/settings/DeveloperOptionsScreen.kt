...
import com.axiom.api.platform.currentArchitecture
import com.axiom.api.ui.LocalToastHostState
import com.axiom.ui.theme.uiFontFamily
import com.axiom.app.icons.BugReport
import com.axiom.app.icons.DeleteSweep
import com.axiom.app.icons.FileDownload
import com.axiom.app.icons.FileUpload
import com.axiom.app.icons.Unarchive
import com.axiom.data.preferences.SettingsRepository
import com.axiom.data.preferences.settingsJson
import com.axiom.presentation.components.dialogs.TerminalWipeConfirmationDialog
import com.axiom.presentation.navigation.LocalNavigator
import com.axiom.presentation.navigation.SettingsScreen
import com.axiom.presentation.screen.settings.components.SettingsItem
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            developerOptionsList(
                ...
                onExportClick = { exportLauncher.launch("axiom-settings.json") },
