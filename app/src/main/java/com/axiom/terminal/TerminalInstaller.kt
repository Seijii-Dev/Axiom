...
import com.axiom.data.file.archive.extractXzTar
import com.axiom.api.data.fs.Paths
import com.axiom.data.fs.downloadFile
...
import com.axiom.api.terminal.versionFile
...
class TerminalInstaller(private val context: Context) {
    ...
    suspend fun installLatest(progress: InstallProgressListener) {
        ...
        val assetName = "axiom-bootstrap-${currentArchitecture()}.tar.xz"
