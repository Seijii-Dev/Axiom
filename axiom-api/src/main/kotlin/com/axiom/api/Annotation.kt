...
/**
 * Marks declarations that are internal to the Axiom ecosystem.
 *
...
@RequiresOptIn(
    ...
    message = "This is an internal Axiom API that should not be used from outside of axiom modules. " +
            "It may be changed or removed in the future without notice."
)
@MustBeDocumented
@Retention(AnnotationRetention.BINARY)
annotation class InternalAxiomApi
