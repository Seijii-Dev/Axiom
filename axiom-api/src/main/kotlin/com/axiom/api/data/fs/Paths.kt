...
/**
 * Utility for accessing standard Android application paths and Axiom-specific directories.
 *
...
/**
 * The directory where installed Axiom plugins are stored.
 */
val Paths.pluginsDir get() = dataDir.resolve("axiom/plugins").also { it.createDirIfMissing() }
