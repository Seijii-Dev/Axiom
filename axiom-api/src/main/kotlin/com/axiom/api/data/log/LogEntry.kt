package com.axiom.api.data.log

/**
 * Represents a single log event within the Axiom ecosystem.
 *
 * `LogEntry` objects are created by the [com.axiom.api.service.Logger] and are used
