...
interface LanguageServerRegistry : PluginService {
    ...
    /**
     * Internal method to register a [LanguageServerProvider] without a [AxiomPlugin] context.
    ...
    /**
     * Returns every [RegisteredProvider] whose pattern matches [file]'s [KxFile.providerKey][com.axiom.api.data.file.providerKey],
