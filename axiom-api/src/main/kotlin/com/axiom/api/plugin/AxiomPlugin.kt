...
import com.axiom.api.service.LogContext
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.currentCoroutineContext
import kotlin.coroutines.CoroutineContext

/**
 * The base interface for all Axiom plugins.
 *
 * Plugins are the core components of the Axiom system, allowing for modular functionality.
 *
 * ### Constructor contract
 * Plugin constructors must not access runtime services ([info], [pluginContext], [runtime]
 * delegates). These are provided by the axiom only after construction and registration, so
...
interface AxiomPlugin : LogContext {
