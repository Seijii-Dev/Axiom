...
import com.axiom.api.DiscouragedInSuspend
import com.axiom.api.ui.ToastDuration
 ...
 */
val AxiomPlugin.info: PluginInfo by runtime()

/**
 * Access the [PluginContext] for this plugin.
 */
val AxiomPlugin.pluginContext: PluginContext by runtime()
...
val AxiomPlugin.lifecycleOwner: PluginLifecycleOwner by runtime()
 ...
 * @see PluginScope
 */
val AxiomPlugin.pluginScope: PluginScope by runtime()
 ...
 */
val AxiomPlugin.settings: PluginSettings by runtime()
...
@Composable
fun AxiomPlugin.withResources(content: @Composable () -> Unit) {
 ...
 */
val AxiomPlugin.toastHostState: ToastHostState
    get() = pluginContext.app.toastHostState

/**
 * Displays a non-blocking toast notification.
 *
 * This function is fire-and-forget; it launches a coroutine in the [AxiomPlugin.pluginScope]
 ...
 */
fun AxiomPlugin.showFailureToast(
    message: String,
    icon: ImageVector? = null
) {
    pluginScope.launch {
 ...
 */
fun AxiomPlugin.showFailureToast(throwable: Throwable) {
    pluginScope.launch {
