...
/**
 * A [LifecycleOwner] that manages the lifecycle of a [AxiomPlugin].
 *
 * This interface bridges the Axiom plugin system with Android's [Lifecycle] components,
 ...
 * ```
 *
 * Alternatively, from a [AxiomPlugin] instance directly:
 *
 * ```kotlin
