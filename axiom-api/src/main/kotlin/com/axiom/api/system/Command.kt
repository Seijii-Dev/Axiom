...
package com.axiom.api.system

import android.annotation.SuppressLint
import com.axiom.api.data.fs.Paths
import com.axiom.api.terminal.home
import com.axiom.api.terminal.processEnv
import com.axiom.api.terminal.prootFile
 ...
 *
 * It automatically handles running binaries within the Axiom PRoot environment if they
...
internal suspend fun resolveProgram(program: String): ResolvedProgram {
    ...
    // Actually, usually in Axiom we want the terminal versions if they exist.
