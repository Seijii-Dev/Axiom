package com.axiom.api.terminal

import android.annotation.SuppressLint
import com.axiom.api.BuildConfig
...
fun terminalArgs(showMotd: Boolean = true, command: String? = null) = listOf(
    ...
    when {
        ...
        showMotd -> "cat /etc/motd; /bin/bash --login -c 'printf \"%s\\n\" \". /root/.bashrc 2>/dev/null\" \". /etc/profile.d/axiom.sh 2>/dev/null\" > /tmp/axiom-rc; exec /bin/bash --rcfile /tmp/axiom-rc'"
