...
interface ScreenRegistry : PluginService {
     ...
     *
     * This method requires a [AxiomPlugin] context to track which plugin registered the screen.
     */
     ...
     *
     * Transient screens are intended to be short-lived: axiom auto-unregisters them when the
