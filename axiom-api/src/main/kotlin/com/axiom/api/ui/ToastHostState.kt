...
import com.axiom.api.util.extractMessage
...
class ToastHostState {
     ...
     *
     * **Recommendation for Plugins:** Use `AxiomPlugin.showToast` instead. This method
     * will suspend the current execution context until the toast is finished. If you want
     * non-blocking behavior, wrap this call in a `scope.launch`, use `AxiomPlugin.showToast`,
 ...
 *
 * **Recommendation for Plugins:** Use `AxiomPlugin.showFailureToast` instead. This method
 * will suspend the current execution context until the toast is finished. If you want
 * non-blocking behavior, wrap this call in a `scope.launch`, use `AxiomPlugin.showFailureToast`,
 * or proceed if suspending the current context is intended.
 */
