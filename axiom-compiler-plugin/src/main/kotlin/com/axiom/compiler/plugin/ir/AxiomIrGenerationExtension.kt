package com.axiom.compiler.plugin.ir
...
class AxiomIrGenerationExtension(
    ...
    override fun generate(moduleFragment: IrModuleFragment, pluginContext: IrPluginContext) {
        ...
        val pluginDescriptorClass = finder.findClass(AxiomPluginIds.PLUGIN_DESCRIPTOR_CLASS_ID) ?: run {
            messageCollector.report(
                CompilerMessageSeverity.ERROR,
                "Axiom compiler plugin: could not resolve PluginDescriptor. Is axiom-api on the classpath?"
            )
            return
        }

        val transformers = listOf(AxiomPluginManifestGenerator(pluginContext, pluginDescriptorClass))
        for (transformer in transformers) {
            moduleFragment.acceptChildrenVoid(transformer)
        }
    }

    private inner class AxiomPluginManifestGenerator(
        ...
        override fun visitClass(declaration: IrClass) {
            if (declaration.hasAnnotation(AxiomPluginIds.PLUGIN_MANIFEST_FQN)) {
        ...
        private fun fillDescriptor(
            ...
            val annotation = pluginClass.getAnnotation(AxiomPluginIds.PLUGIN_MANIFEST_FQN) ?: return
            ...
            val descriptorProperty = companion.declarations
                ...
                .firstOrNull { it.name == AxiomPluginIds.DESCRIPTOR_PROPERTY_NAME }
                ?: return
        ...
        private fun writeDescriptorJson(
            ...
            messageCollector.report(
                ...
                "Axiom compiler plugin: wrote generated plugin.json for '$id'"
            )
        }
        ...
        private fun buildPluginAuthorCall(
            ...
            val authorClass = finder.findClass(AxiomPluginIds.PLUGIN_AUTHOR_CLASS_ID)
        ...
        private fun buildPluginLinksCall(
            ...
            val linksClass = finder.findClass(AxiomPluginIds.PLUGIN_LINKS_CLASS_ID)
