...
abstract class AxiomPluginExtension @Inject constructor(private val project: Project) {
    ...
    /** Target folder for built bundles. Defaults to 'build/axiom/' */
    abstract val outputDirectory: DirectoryProperty

    /** Whether to automatically push the bundle to device's axiom/plugins directory using adb */
