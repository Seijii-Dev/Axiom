package com.axiom.editor.treesitter
        ...
        operator fun invoke(
            ...
            fun parseQuery(queryName: String): Query? {
                return try {
                    ...
                    Log.w("Axiom", "Failed to parse query: $queryName.scm for language '$languageName'", e)
                    null
                }
            }
        ...
        fun fromSource(
            ...
            fun parseQuery(queryName: String, source: String?): Query? {
                return try {
                    ...
                    Log.w("Axiom", "Failed to parse $queryName query for language '$languageName'", e)
                    null
                }
            }
