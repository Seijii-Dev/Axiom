...
import com.axiom.lsp.ErrorCodes.InvalidRequest
import com.axiom.lsp.InitializeParams
import com.axiom.lsp.InitializeResult
import com.axiom.lsp.InitializedParams
import com.axiom.lsp.SetTraceParams
import com.axiom.lsp.WorkDoneProgressCancelParams
...
fun LanguageServer(
    ...
    out: RawSource,
    `in`: RawSink
): LanguageServer = createLanguageServer(client, out, `in`)
...
fun LanguageServer(
    ...
    stdout: InputStream,
    stdin: OutputStream
): LanguageServer = LanguageServer(client, `in` = stdin.asSink(), out = stdout.asSource())
