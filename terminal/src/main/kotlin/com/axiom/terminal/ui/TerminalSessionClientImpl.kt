...
import com.axiom.terminal.BellSoundType
import com.axiom.terminal.TerminalBell
...
private class TerminalSessionClientImpl(
    ...
    override suspend fun onCopyTextToClipboard(session: TerminalSession, text: String?) {
        clipboard.setClipEntry(ClipData.newPlainText("axiom", text ?: return).toClipEntry())
    }
